export function Hero() {
  return (
    <section className="hero" aria-labelledby="hero-title">
      ...
      <p>
        Moderner Auftritt, klare Struktur und ein eigenständiges CMS. Dies ist der Prototyp für den neuen
        Webauftritt – mit Spielplan, News und Sponsoren-Fokus.
      </p>
      <div className="hero-actions">
        <button className="btn btn-primary">Mitglied werden</button>
        <button className="btn btn-secondary">Zum Heimspiel-Kalender</button>
      </div>
